    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    Card Title
                    <a style="float: right;" href="{{ route('etiket.create') }}" class="btn icon icon-left btn-secondary"><i
                            ...
                            <td>
                                <div class="comment-actions">
                                    <button class="btn icon icon-left btn-primary me-2 text-nowrap">
                                        <a href="{{-- route('etiket.edit', $tag->id) --}}" style="color: white; text-decoration: none;">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                    </button>
                                    <form id="deleteForm" action="{{-- route('etiket.destroy', $tag->id) --}}" method="POST"
